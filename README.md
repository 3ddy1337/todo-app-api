...
- [ ] Clone the this repository to your local machine: https://github.com/coding-bootcamps-eu/todo-api
- [ ] Use NPM to install the dependencies of the Todo API
- [ ] Use the `npm run start` command to start the backend
- [ ] Follow the instructions on in the terminal and try to access the Todo API in the browser
